...
load('../data/stl10/stlTrainSubset.mat'); % loads numTrainImages, trainImages, trainLabels
...
load('../data/stl10/stlTrainSubset.mat'); % loads numTrainImages, trainImages, trainLabels
load ('../data/stl10/stlTestSubset.mat');  % loads numTestImages,  testImages,  testLabels
